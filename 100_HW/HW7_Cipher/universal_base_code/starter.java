...
class starter {
	public static void main(String args[]) {
		...
		System.out.println(Cipher.keyedEncode("29y4 v4 v2q9w1r 05sr5l wpx85s 1r z5l qv d", 36));
		...
		System.out.println(Cipher.keyedEncode("549q94u8 q3t sxys0u3 q7u 2e vqb47y9u bq7yqr1u 3q2u8", 29));
		System.out.println(Cipher.keyedEncode("lvpo5 rp775rr4pyyl 7vxuy5q56 q25 41srq r57q1vw", 36));
